        ...
        {% if parent_page.is_root %}
            <tr><td colspan="6"><div class="help-block help-info">
                {% if perms.wagtailcore.add_site %}
                    ...
                    <p>
                        {% blocktrans %}
                            The root level is where you can add new sites to your NueUi installation. Pages created here will not be accessible at any URL until they are associated with a site.
                        {% endblocktrans %}
